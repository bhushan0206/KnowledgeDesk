...
?>
<div class="form-group control-group<?php echo form_error($field['name']) ? ' error' : ''; ?>">
    <label class="col-lg-2 control-label" for="<?php echo $field['name']; ?>"><?php echo lang('user_meta_state'); ?></label>
    <div class="controls col-md-6">
        <?php
        echo state_select(
...
<div class="form-group control-group<?php echo form_error($field['name']) ? ' error' : ''; ?>">
    <label class="col-lg-2 control-label" for="<?php echo $field['name']; ?>"><?php echo lang('user_meta_country'); ?></label>
    <div class="controls col-md-6">
        <?php
        echo country_select(
