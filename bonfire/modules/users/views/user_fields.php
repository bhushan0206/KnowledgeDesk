...
<div class="control-group form-group<?php echo form_error('email') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required" for="email"><?php echo lang('bf_email'); ?></label>
...
<div class="control-group form-group<?php echo form_error('display_name') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required" for="display_name"><?php echo lang('bf_display_name'); ?></label>
    <div class="controls col-md-6">
...
<div class="control-group form-group<?php echo form_error('username') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required required" for="username"><?php echo lang('bf_username'); ?></label>
    <div class="controls col-md-6">
...
<?php endif; ?>
<div class="control-group form-group<?php echo form_error('password') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required<?php echo $registerClass; ?>" for="password"><?php echo lang('bf_password'); ?></label>
    <div class="controls col-md-6">
...
<div class="control-group form-group<?php echo form_error('pass_confirm') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required<?php echo $registerClass; ?>" for="pass_confirm"><?php echo lang('bf_password_confirm'); ?></label>
    <div class="controls col-md-6">
...
<?php if ($editSettings) : ?>
<div class="control-group form-group<?php echo form_error('force_password_reset') ? $errorClass : ''; ?>">
    <div class="controls col-md-6">
...
?>
<div class="control-group form-group<?php echo form_error('language') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required required" for="language"><?php echo lang('bf_language'); ?></label>
    <div class="controls col-md-6">
...
?>
<div class="control-group form-group<?php echo form_error('timezones') ? $errorClass : ''; ?>">
    <label class="col-lg-2 control-label required required" for="timezones"><?php echo lang('bf_timezone'); ?></label>
    <div class="controls col-md-6">
        <?php
        echo timezone_menu(
